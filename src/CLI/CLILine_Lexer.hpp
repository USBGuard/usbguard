...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLILINE____LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLILINE____LEXER
...
#   ifdef   __QUEX_SIGNAL_DEFINED_LEXER_IN_NAMESPACE___CLILINE__
...
#   undef   __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLILINE____LEXER
#else
#   define  __QUEX_INCLUDE_INDICATOR__ANALYZER__MAIN
#endif
#define     __QUEX_SIGNAL_DEFINED_LEXER_IN_NAMESPACE___CLILINE__

#include "CLILine_Lexer-configuration.hpp"
...
enum {
    QUEX_NAME(ModeID_CLI) = 0,
    QUEX_NAME(ModeID_DQ_STRING_READER) = 1
};

        extern QUEX_NAME(Mode)  QUEX_NAME(CLI);
        extern QUEX_NAME(Mode)  QUEX_NAME(DQ_STRING_READER);


extern     __QUEX_TYPE_ANALYZER_RETURN_VALUE QUEX_NAME(CLI_analyzer_function)(QUEX_TYPE_ANALYZER*);
#ifdef QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK
extern     bool QUEX_NAME(CLI_has_base)(const QUEX_NAME(Mode)*);
extern     bool QUEX_NAME(CLI_has_entry_from)(const QUEX_NAME(Mode)*);
extern     bool QUEX_NAME(CLI_has_exit_to)(const QUEX_NAME(Mode)*);
#endif
...
private:
    ...
    friend     __QUEX_TYPE_ANALYZER_RETURN_VALUE QUEX_NAME(CLI_analyzer_function)(QUEX_TYPE_ANALYZER*);
#ifdef QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK
    friend     bool QUEX_NAME(CLI_has_base)(const QUEX_NAME(Mode)*);
    friend     bool QUEX_NAME(CLI_has_entry_from)(const QUEX_NAME(Mode)*);
    friend     bool QUEX_NAME(CLI_has_exit_to)(const QUEX_NAME(Mode)*);
#endif
...
{
    __quex_assert(QUEX_NAME(ModeID_CLI)              < 2);
    __quex_assert(QUEX_NAME(ModeID_DQ_STRING_READER) < 2);

    QUEX_NAME(CLI).id   = QUEX_NAME(ModeID_CLI);
    QUEX_NAME(CLI).name = "CLI";
    QUEX_NAME(CLI).analyzer_function = QUEX_NAME(CLI_analyzer_function);
#   if      defined(QUEX_OPTION_INDENTATION_TRIGGER) \
       && ! defined(QUEX_OPTION_INDENTATION_DEFAULT_HANDLER)
    QUEX_NAME(CLI).on_indentation = QUEX_NAME(Mode_on_indentation_null_function);
#   endif
    QUEX_NAME(CLI).on_entry       = QUEX_NAME(Mode_on_entry_exit_null_function);
    QUEX_NAME(CLI).on_exit        = QUEX_NAME(Mode_on_entry_exit_null_function);
#   if      defined(QUEX_OPTION_RUNTIME_MODE_TRANSITION_CHECK)
    QUEX_NAME(CLI).has_base       = QUEX_NAME(CLI_has_base);
    QUEX_NAME(CLI).has_entry_from = QUEX_NAME(CLI_has_entry_from);
    QUEX_NAME(CLI).has_exit_to    = QUEX_NAME(CLI_has_exit_to);
#   endif
...
#   endif
        me->mode_db[QUEX_NAME(ModeID_CLI)]              = &(QUEX_NAME(CLI));
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLILINE____LEXER */
