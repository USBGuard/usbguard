...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLIARGV____LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLIARGV____LEXER
...
#define QUEX_SETTING_BUILD_DATE        "Sat May  9 13:53:25 2015"
...
#   define QUEX_FUNCTION_PREFIX        CLIArgv_Lexer_
#   define QUEX_FUNCTION_DEF_PREFIX    CLIArgv_Lexer_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct CLIArgv_Lexer_tag
#   define QUEX_TYPE_ANALYZER          struct CLIArgv_Lexer_tag
#   define QUEX_NAME_COMPLETE_ANALYZER CLIArgv_Lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  struct CLIArgv_Lexer_tag

#   define QUEX_TYPE0_TOKEN            struct CLIArgv_Token_tag
#   define QUEX_TYPE_TOKEN             struct CLIArgv_Token_tag
#   define QUEX_NAME_COMPLETE_TOKEN    CLIArgv_Token

#   define QUEX_NAMESPACE_MAIN         CLIArgv_Lexer
...
#   define QUEX_LEXEME_NULL_IN_ITS_NAMESPACE   CLIArgv_LexemeNullObject
#   define QUEX_LEXEME_NULL                    CLIArgv_LexemeNullObject

#   define QUEX_NAME(NAME)             CLIArgv_Lexer_ ## NAME
#   define QUEX_NAME_TOKEN(NAME)       CLIArgv_Token_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       CLIArgv_Lexer_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   CLIArgv_Lexer_

#else
#   define QUEX_FUNCTION_DEF_PREFIX    /* Supposed we are IN the namespace for definition. */
#   define QUEX_FUNCTION_PREFIX        ::CLIArgv::
    /* Add namespaces for the global names of the classes of analyzer
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         Lexer
#   define QUEX_TYPE_ANALYZER          ::CLIArgv::Lexer
#   define QUEX_NAME_COMPLETE_ANALYZER ::CLIArgv::Lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  Lexer

#   define QUEX_TYPE0_TOKEN            Token
#   define QUEX_TYPE_TOKEN             ::CLIArgv::Token
#   define QUEX_NAME_COMPLETE_TOKEN    ::CLIArgv::Token

#   define QUEX_NAMESPACE_MAIN         ::CLIArgv
#   define QUEX_NAMESPACE_MAIN_OPEN    namespace CLIArgv {\

#   define QUEX_NAMESPACE_MAIN_CLOSE   } /* Closing Namespace 'CLIArgv' */\


#   define QUEX_NAMESPACE_TOKEN        ::CLIArgv
#   define QUEX_NAMESPACE_TOKEN_OPEN   namespace CLIArgv {\

#   define QUEX_NAMESPACE_TOKEN_CLOSE  } /* Closing Namespace 'CLIArgv' */\


#   define QUEX_NAMESPACE_LEXEME_NULL_OPEN     namespace CLIArgv {\

#   define QUEX_NAMESPACE_LEXEME_NULL_CLOSE    } /* Closing Namespace 'CLIArgv' */\

#   define QUEX_LEXEME_NULL_IN_ITS_NAMESPACE   LexemeNullObject
#   define QUEX_LEXEME_NULL                    ::CLIArgv::LexemeNullObject
...
#   define QUEX_MEMBER(NAME)           Lexer::NAME                
     ...
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
#   define QUEX_NAMESPACE_MAIN_OPEN_BACKUP   namespace CLIArgv {\

#   define QUEX_NAMESPACE_MAIN_CLOSE_BACKUP  } /* Closing Namespace 'CLIArgv' */\

#   define QUEX_FUNCTION_PREFIX_BACKUP        
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   ::CLIArgv::
#endif
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLIARGV____LEXER */
