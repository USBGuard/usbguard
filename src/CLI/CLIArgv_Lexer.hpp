...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLIARGV____LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLIARGV____LEXER
...
#   ifdef   __QUEX_SIGNAL_DEFINED_LEXER_IN_NAMESPACE___CLIARGV__
...
#   undef   __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLIARGV____LEXER
#else
#   define  __QUEX_INCLUDE_INDICATOR__ANALYZER__MAIN
#endif
#define     __QUEX_SIGNAL_DEFINED_LEXER_IN_NAMESPACE___CLIARGV__

#include "CLIArgv_Lexer-configuration.hpp"
...
{
    __quex_assert(QUEX_NAME(ModeID_CLI) < 1);
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__GENERATED____CLIARGV____LEXER */
