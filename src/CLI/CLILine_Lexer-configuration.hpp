...
#ifndef __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLILINE____LEXER
#define __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLILINE____LEXER
...
#define QUEX_SETTING_BUILD_DATE        "Sat May  9 13:53:20 2015"
...
#   define __QUEX_SETTING_INITIAL_LEXER_MODE_ID    (QUEX_NAME(ModeID_CLI))
#endif
/* NOTE: QUEX_TYPE_TOKEN_ID is later on defined inside the token class header. */
#define    __QUEX_SETTING_TOKEN_ID_TERMINATION       ((QUEX_TYPE_TOKEN_ID)CLI_TOKEN_TERMINATION)
#define    __QUEX_SETTING_TOKEN_ID_UNINITIALIZED     ((QUEX_TYPE_TOKEN_ID)CLI_TOKEN_UNINITIALIZED)
#define    __QUEX_SETTING_TOKEN_ID_INDENT            ((QUEX_TYPE_TOKEN_ID)CLI_TOKEN_INDENT)
#define    __QUEX_SETTING_TOKEN_ID_DEDENT            ((QUEX_TYPE_TOKEN_ID)CLI_TOKEN_DEDENT)
#define    __QUEX_SETTING_TOKEN_ID_NODENT            ((QUEX_TYPE_TOKEN_ID)CLI_TOKEN_NODENT)
...
#   define QUEX_FUNCTION_PREFIX        CLILine_Lexer_
#   define QUEX_FUNCTION_DEF_PREFIX    CLILine_Lexer_
    /* In 'C' there are no namespaces, so namespaces are coded directly
     * into the type name. Both, global and local names are equal.       */
#   define QUEX_TYPE0_ANALYZER         struct CLILine_Lexer_tag
#   define QUEX_TYPE_ANALYZER          struct CLILine_Lexer_tag
#   define QUEX_NAME_COMPLETE_ANALYZER CLILine_Lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  struct CLILine_Lexer_tag

#   define QUEX_TYPE0_TOKEN            struct CLILine_Token_tag
#   define QUEX_TYPE_TOKEN             struct CLILine_Token_tag
#   define QUEX_NAME_COMPLETE_TOKEN    CLILine_Token

#   define QUEX_NAMESPACE_MAIN         CLILine_Lexer
...
#   define QUEX_LEXEME_NULL_IN_ITS_NAMESPACE   CLILine_LexemeNullObject
#   define QUEX_LEXEME_NULL                    CLILine_LexemeNullObject

#   define QUEX_NAME(NAME)             CLILine_Lexer_ ## NAME
#   define QUEX_NAME_TOKEN(NAME)       CLILine_Token_ ## NAME
...
#   define QUEX_FUNCTION_PREFIX_BACKUP       CLILine_Lexer_
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   CLILine_Lexer_

#else
#   define QUEX_FUNCTION_DEF_PREFIX    /* Supposed we are IN the namespace for definition. */
#   define QUEX_FUNCTION_PREFIX        ::CLILine::
    /* Add namespaces for the global names of the classes of analyzer
     * and token.                                                        */
#   define QUEX_TYPE0_ANALYZER         Lexer
#   define QUEX_TYPE_ANALYZER          ::CLILine::Lexer
#   define QUEX_NAME_COMPLETE_ANALYZER ::CLILine::Lexer
#   define QUEX_TYPE_DERIVED_ANALYZER  Lexer

#   define QUEX_TYPE0_TOKEN            Token
#   define QUEX_TYPE_TOKEN             ::CLILine::Token
#   define QUEX_NAME_COMPLETE_TOKEN    ::CLILine::Token

#   define QUEX_NAMESPACE_MAIN         ::CLILine
#   define QUEX_NAMESPACE_MAIN_OPEN    namespace CLILine {\

#   define QUEX_NAMESPACE_MAIN_CLOSE   } /* Closing Namespace 'CLILine' */\


#   define QUEX_NAMESPACE_TOKEN        ::CLILine
#   define QUEX_NAMESPACE_TOKEN_OPEN   namespace CLILine {\

#   define QUEX_NAMESPACE_TOKEN_CLOSE  } /* Closing Namespace 'CLILine' */\


#   define QUEX_NAMESPACE_LEXEME_NULL_OPEN     namespace CLILine {\

#   define QUEX_NAMESPACE_LEXEME_NULL_CLOSE    } /* Closing Namespace 'CLILine' */\

#   define QUEX_LEXEME_NULL_IN_ITS_NAMESPACE   LexemeNullObject
#   define QUEX_LEXEME_NULL                    ::CLILine::LexemeNullObject
...
#   define QUEX_MEMBER(NAME)           Lexer::NAME                
     ...
     * This happens to generate converters in the token's namespace. After 
     * that, the original macros need to be restored. Thus: Backup!          */  
#   define QUEX_NAMESPACE_MAIN_OPEN_BACKUP   namespace CLILine {\

#   define QUEX_NAMESPACE_MAIN_CLOSE_BACKUP  } /* Closing Namespace 'CLILine' */\

#   define QUEX_FUNCTION_PREFIX_BACKUP        
#   define QUEX_FUNCTION_DEF_PREFIX_BACKUP   ::CLILine::
#endif
...
#endif /* __QUEX_INCLUDE_GUARD__ANALYZER__CONFIGURATION____CLILINE____LEXER */
