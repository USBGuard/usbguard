...
#endif
#define RuleParserARG_SDECL  Firewall::Rule* rule ;
#define RuleParserARG_PDECL , Firewall::Rule* rule 
#define RuleParserARG_FETCH  Firewall::Rule* rule  = yypParser->rule 
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */     7,    6,    5,    4,   59,   18,    1,   21,   20,   19,
 /*    10 */    35,   23,   10,   24,   26,   17,   17,    9,   15,   11,
 /*    20 */    14,   32,   12,   16,   13,    2,   22,   34,    3,    8,
 /*    30 */    60,   33,   17,   30,   60,   60,   60,   31,   60,   29,
 /*    40 */    28,   27,   25,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     9,   10,   11,   12,   22,   23,   24,    3,    4,    5,
 /*    10 */     0,    6,   13,    8,   14,   16,   16,   25,    6,   27,
 /*    20 */     8,   18,    7,   17,    7,   28,    8,   26,   21,   15,
 /*    30 */    30,   20,   16,   20,   30,   30,   30,   29,   30,   20,
 /*    40 */    20,   20,   20,
};
...
static const signed char yy_shift_ofst[] = {
 /*     0 */     4,   12,   -9,    0,   -1,   16,   16,   16,   16,   14,
 /*    10 */   -10,  -10,    5,   18,   17,   15,    3,    6,   10,
};
...
static const signed char yy_reduce_ofst[] = {
 /*     0 */   -18,   -8,    8,   22,   21,   20,   19,   13,   11,    1,
 /*    10 */     7,   -3,
};
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    37,   45,   41,   58,   58,   58,   58,   58,   58,   56,
 /*    10 */    54,   47,   58,   58,   58,   58,   58,   58,   58,   40,
 /*    20 */    39,   38,   44,   43,   42,   53,   52,   51,   50,   49,
 /*    30 */    48,   46,   57,   55,   36,
};
...
static const char *const yyTokenName[] = { 
  ...
  "KEYWORD_DENY",  "KEYWORD_REJECT",  "HEXCHAR4",      "COLON",       
  "ASTERISK",      "KEYWORD_CLASS",  "KEYWORD_HASH",  "KEYWORD_NAME",
  "KEYWORD_PORT",  "CURLYBRACE_OPEN",  "CURLYBRACE_CLOSE",  "KEYWORD_ACTION",
  "DQ_STRING_BEGIN",  "DQ_STRING",     "DQ_STRING_END",  "error",       
  "string",        "stringvec",     "rule",          "rule_spec",   
  "target",        "device_spec",   "action",        "device_id",   
...
static const char *const yyRuleName[] = {
 ...
 /*  13 */ "device_attribute ::= KEYWORD_CLASS string",
 /*  14 */ "device_attribute ::= KEYWORD_HASH string",
 /*  15 */ "device_attribute ::= KEYWORD_NAME string",
 /*  16 */ "device_attribute ::= KEYWORD_PORT string",
 /*  17 */ "device_attribute ::= KEYWORD_PORT CURLYBRACE_OPEN stringvec CURLYBRACE_CLOSE",
 /*  18 */ "stringvec ::= stringvec string",
 /*  19 */ "stringvec ::=",
 /*  20 */ "action ::= KEYWORD_ACTION string",
 /*  21 */ "action ::=",
 /*  22 */ "string ::= DQ_STRING_BEGIN DQ_STRING DQ_STRING_END",
};
#endif /* NDEBUG */
...
static void yy_destructor(
  ...
  switch( yymajor ){
    ...
    */
    ...
    case 7: /* COLON */
    case 8: /* ASTERISK */
    case 9: /* KEYWORD_CLASS */
    case 10: /* KEYWORD_HASH */
    case 11: /* KEYWORD_NAME */
    case 12: /* KEYWORD_PORT */
    case 13: /* CURLYBRACE_OPEN */
    case 14: /* CURLYBRACE_CLOSE */
    case 15: /* KEYWORD_ACTION */
    case 16: /* DQ_STRING_BEGIN */
    case 17: /* DQ_STRING */
    case 18: /* DQ_STRING_END */
{
#line 18 "Parser.y"
 delete (yypminor->yy0); 
#line 422 "Parser.c"
...
#line 51 "Parser.y"
{ // 1234:*
	  rule->id_vendor = (char *)yymsp[-2].minor.yy0->get_text().c_str();
...
{ // 1234:5678
	  rule->id_vendor = (char *)yymsp[-2].minor.yy0->get_text().c_str();
	  rule->id_product = (char *)yymsp[0].minor.yy0->get_text().c_str();
	  delete yymsp[-2].minor.yy0;
...
#line 803 "Parser.c"
        break;
      case 13: /* device_attribute ::= KEYWORD_CLASS string */
#line 69 "Parser.y"
{
		 rule->usb_class = *yymsp[0].minor.yy14;
...
#line 79 "Parser.y"
{
		 rule->name = *yymsp[0].minor.yy14;
		 delete yymsp[0].minor.yy14;
  yy_destructor(yypParser,11,&yymsp[-1].minor);
}
#line 830 "Parser.c"
        break;
      case 16: /* device_attribute ::= KEYWORD_PORT string */
#line 84 "Parser.y"
{
		 rule->id_ports.push_back(*yymsp[0].minor.yy14);
		 delete yymsp[0].minor.yy14;
  yy_destructor(yypParser,12,&yymsp[-1].minor);
}
#line 839 "Parser.c"
        break;
      case 17: /* device_attribute ::= KEYWORD_PORT CURLYBRACE_OPEN stringvec CURLYBRACE_CLOSE */
#line 89 "Parser.y"
{
		 rule->id_ports.insert(rule->id_ports.end(), yymsp[-1].minor.yy9->begin(), yymsp[-1].minor.yy9->end());
...
#line 850 "Parser.c"
        break;
      case 18: /* stringvec ::= stringvec string */
#line 94 "Parser.y"
{
	  yygotominor.yy9 = yymsp[-1].minor.yy9;
	  yygotominor.yy9->push_back(*yymsp[0].minor.yy14);
	  delete yymsp[0].minor.yy14;
}
#line 859 "Parser.c"
        break;
...
#line 866 "Parser.c"
        break;
      case 20: /* action ::= KEYWORD_ACTION string */
#line 104 "Parser.y"
{
       rule->action = *yymsp[0].minor.yy14;
       delete yymsp[0].minor.yy14;
  yy_destructor(yypParser,15,&yymsp[-1].minor);
}
#line 875 "Parser.c"
        break;
      case 22: /* string ::= DQ_STRING_BEGIN DQ_STRING DQ_STRING_END */
#line 111 "Parser.y"
{
	  yygotominor.yy14 = new String((char *)yymsp[-1].minor.yy0->get_text().c_str());
...
#line 885 "Parser.c"
      ...
      /* (21) action ::= */ yytestcase(yyruleno==21);
        break;
  };
