...
See the <<device-attributes,Device Attributes>> section for the list of available attributes and <<conditions,Conditions>> for the list of supported rule rule conditions.
...
See the http://www.usb.org/developers/defined_class[list of assigned classes, subclasses and protocols] for details.
